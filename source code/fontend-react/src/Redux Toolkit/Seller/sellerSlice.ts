...
// Async thunk for creating a new seller by admin
export const createSeller = createAsyncThunk<Seller, { seller: Omit<Seller, 'id'>; jwt: string }, { rejectValue: string }>(
...
const sellerSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
     ...
     .addCase(createSeller.rejected, (state, action: PayloadAction<string | undefined>) => {
       state.loading = false;

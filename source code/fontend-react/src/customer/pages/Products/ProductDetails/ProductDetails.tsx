...
const ProductDetails = () => {
    ...
    const isInWishlist = !!(wishlistState.wishlist && products.product && isWishlisted(wishlistState.wishlist, products.product));
                ...
                <section>
                    ...
                    <div className="mt-12 flex items-center gap-5">
                        ...
                        <Button
                            ...
                            variant='outlined'
                            fullWidth
                            startIcon={isInWishlist ? <FavoriteIcon sx={{ color: teal[500] }} /> : <FavoriteBorderIcon sx={{ color: teal[500] }} />}
                        >
